            ...
            <div className="space-y-4 mb-8">
              ...
              <div className="flex items-center gap-3">
                ...
                <div>
                  ...
                  <div>+977 1 234 5678</div>
                </div>
              </div>
            </div>

            <button className="px-8 py-4 bg-white text-blue-600 rounded-full hover:bg-blue-50 transition-all duration-300 flex items-center gap-2 group">
              Get In Touch
